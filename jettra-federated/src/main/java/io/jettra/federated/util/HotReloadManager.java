package io.jettra.federated.util;
...
/**
 * Utility to handle Hot-Reload/Restart of the Federated Server node across different environments.
 */
public class HotReloadManager {
        ...
        new Thread(() -> {
            try {
                ...
                if (isContainerized()) {
                    ...
                    LOGGER.info("Environment: SUPERVISED. Exiting with code 3. Script loop will handle the restart.");
                    System.exit(3);
    ...
    private static boolean relaunch() {
        try {
            ...
            LOGGER.info("Relaunching standalone federated server: " + String.join(" ", javaCmd));
